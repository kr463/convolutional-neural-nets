...
class AnimalBaselineNet(nn.Module):
    def __init__(self, num_classes=16):
        ...
        # TODO-BLOCK-BEGIN
        self.conv1 = nn.Conv2d(64, 6, kernel_size=3, stride=2, padding=1)
        self.conv2 = nn.Conv2d(32, 12, kernel_size=3, stride=2, padding=1)
        self.conv3 = nn.Conv2d(16, 24, kernel_size=3, stride=2, padding=1)
        self.pool = torch.nn.MaxPool2d(kernel_size=2, stride=2, padding=0)
        self.fc1 = torch.nn.Linear(18 * 16 * 16, 128)
